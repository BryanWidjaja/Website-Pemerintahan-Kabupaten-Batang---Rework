    ...
    .then((data) => {
      ...
      <div class="main-berita-info-row">
        <div class="main-berita-info-container">
          <img src="../assets/icons/date.svg" alt="date : " class="main-berita-info-icon" />
          <p class="main-berita-date">${article.date}</p>
        </div>
        <div class="main-berita-info-container">
          <img src="../assets/icons/user.svg" alt="writer : " class="main-berita-info-icon" />
          <p class="main-berita-writer">${article.writer}</p>
        </div>
        <div class="main-berita-info-container">
          <img src="../assets/icons/tag.svg" alt="category : " class="main-berita-info-icon" />
